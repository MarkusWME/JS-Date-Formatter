...
function TimezoneManager() {
    var _timezones = [
        {
            ...
            baseUTCOffset: +9.5,
            DSTDirection: +1,
            getDSTStart: getAustralianDSTStart,
            getDSTEnd: getAustralianDSTEnd
        }, {
            ...
            baseUTCOffset: +13,
            DSTDirection: +1,
            getDSTStart: getSamoaDSTStart,
            getDSTEnd: getSamoaDSTEnd
        }, {
    ...
    function getAustralianDSTStart(year) {
        //noinspection JSUnresolvedVariable
        return convertDateToMatchTimezone(new Date(year, 9, findFirstOfMonth(year, 9, 0), 2, 0, 0, 0), this.baseUTCOffset + this.DSTDirection);
    }

    function getAustralianDSTEnd(year) {
        //noinspection JSUnresolvedVariable
        return convertDateToMatchTimezone(new Date(year, 3, findFirstOfMonth(year, 3, 0), 3, 0, 0, 0), this.baseUTCOffset + this.DSTDirection);
    }

    function getSamoaDSTStart(year) {
        //noinspection JSUnresolvedVariable
        return convertDateToMatchTimezone(new Date(year, 8, findLastOfMonth(year, 8, 0), 3, 0, 0, 0), this.baseUTCOffset + this.DSTDirection);
    }

    function getSamoaDSTEnd(year) {
        //noinspection JSUnresolvedVariable
        return convertDateToMatchTimezone(new Date(year, 3, findFirstOfMonth(year, 3, 0), 4, 0, 0, 0), this.baseUTCOffset + this.DSTDirection);
    }
